...
<?php 
    ...
    $categorys = mysqli_query($strConnection,$sql);
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php
                    ...
                    ?>
                    <form class="d-flex flex-column" action="process_edit.php" method="post">
                            <h4 class="text-center text-uppercase fw-bold pb-2">Sửa thông tin thể loại</h4>
                        <div class="form_group d-flex rounded border">
                            <span class="bg-light py-2 px-3" style="width:130px"  >Mã thể loại</span>
                            <input type="text" name="ma_tloai" id="ma_tloai" class="form_input border-0 w-100" value="<?= $category['ma_tloai']?>">
                        </div>
                        <div class="form_group d-flex rounded border">
                            <span class="bg-light py-2 px-3" style="width:130px" >Tên thể loại</span>
                            <input type="text" name="ten_tloai" id="ten_tloai" class="form_input border-0 w-100" value="<?= $category['ten_tloai']?>">
                        </div>
